    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="<?php echo base_url('Admin/f_index'); ?>"><img src="<?php echo base_url(''); ?>assets/images/logo.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li>
                                <a href="<?php echo base_url('Admin/index'); ?>"><span>Dashboard</span></a></li>
                            <li class="active"><a href="<?php echo base_url('Admin/f_index'); ?>"><i class="ti-layout"></i><span>Formulir</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('Admin/u_index'); ?>"><i class="ti-layout"></i><span>User Terdaftar</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('Admin/a_index'); ?>"><i class="ti-layout"></i><span>Kelola Admin</span></a>
                            </li>
                            <li>
